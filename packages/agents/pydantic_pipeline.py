...
from packages.agents.core.workspace import _quote_ident as _q
from packages.agents.core.logging_utils import log_llm_usage
...
class PydanticPipeline(AgentPipeline):
    ...
    def _register_phase_tools(self, agent, ws: Workspace, phase: str):
        from .core.tools.adapters.pydantic_tools import register_pydantic_tools
        return register_pydantic_tools(agent, phase)
